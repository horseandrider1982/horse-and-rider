...
const Widerrufsrecht = () => (
  <LegalPageLayout title="Widerrufsrecht" description="Widerrufsbelehrung und Muster-Widerrufsformular der Horse & Rider Reitsportfachhandels GmbH." slug="widerrufsrecht">
    ...
    <p>Sie haben das Recht, binnen eines Monats ohne Angabe von Gründen diesen Vertrag zu widerrufen.</p>
    <p>Die Widerrufsfrist beträgt einen Monat ab dem Tag,</p>
    <ul>
    ...
    <p>
      Um Ihr Widerrufsrecht auszuüben, müssen Sie uns <strong>(Horse &amp; Rider Reitsportfachhandels GmbH, Alte Dorfstraße 8, 21376 Salzhausen, Telefonnr.: 04172/6403, E-Mail-Adresse: info@horse-and-rider.de)</strong> mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief oder eine E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie können dafür das beigefügte Muster-Widerrufsformular verwenden, das jedoch nicht vorgeschrieben ist.
    </p>

    <p>Sie können das Muster-Widerrufsformular oder eine andere eindeutige Erklärung auch auf unserer Webseite (horse-and-rider.de) elektronisch ausfüllen und übermitteln. Machen Sie von dieser Möglichkeit Gebrauch, so werden wir Ihnen unverzüglich (z.B. per E-Mail) eine Bestätigung über den Eingang eines solchen Widerrufs übermitteln.</p>
    ...
    <ul>
      <li>An Horse &amp; Rider Reitsportfachhandels GmbH, Alte Dorfstraße 8, 21376 Salzhausen, E-Mail-Adresse: info@horse-and-rider.de :</li>
